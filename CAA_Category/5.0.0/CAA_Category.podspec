...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is CAA_Category
                   DESC

  s.homepage     = "https://github.com/jiaqipang/CAA_Category"
  ...
  s.source       = { :git => "https://github.com/jiaqipang/CAA_Category.git", :tag => s.version.to_s }
  ...
  s.source_files  = "CAA_Category/CAA_Category/**/*.{h,m}"
